...
//
// Copyright of The $IRIS Token

// $IRIS has 7% tax split across 7 protocols
...
/**
 * @dev The official IRISToken smart contract
 */
contract IrisToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "IrisToken";
    string private _symbol   = "IrisToken";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for IRIS/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x3BEe6c91754aD116a655f21390de78B949eB4594); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $IRIS will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-IRIS tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts IRIS balance for buybacks, developpement, liquidity and marketing
    ...
    /**
     * @notice Burns IRIS tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of IRIS tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from IRIS)
